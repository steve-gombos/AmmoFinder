...
namespace AmmoFinder.Parsers
{
    ...
    {
        public Dictionary<string, IEnumerable<SearchCriteria>> CaliberMap = new Dictionary<string, IEnumerable<SearchCriteria>>
        {
            {"RimFire", new List<SearchCriteria>
                {
                    new SearchCriteria
                    {
                        Name = "17 HMR",
            ...
            {"Pistol", new List<SearchCriteria>
            {
                new SearchCriteria
                    {
                        Name = "10mm",
            ...
            {"Shotgun", new List<SearchCriteria>
            {
                new SearchCriteria
                    {
                        Name = "10 Gauge",
        ...
        public string Parse(string description)
        {
            ...
            foreach (var firearmGrouping in CaliberMap)
            {
