...
namespace AmmoFinder.Parsers.UnitTests
{
    public class CaliberParserTests
    {
        ...
        */
        ...
        [InlineData("17 Win Super Mag - 20 gr - Polymer Tip - Federal American Eagle - 50 Rounds", "17 WSM")]
        [InlineData("17 Mach 2 (HM2) - 15.5 Grain NTX - Hornady Varmint Express - 500 Rounds", "17 HM2")]
        [InlineData("17 Hornady Mach 2 (HM2) - 17 gr V-MAX - Hornady - 50 Rounds", "17 HM2")]
        ...
        [InlineData("22 Winchester Automatic - 45 gr LRN - Aguila - 50 Rounds - (Model 1903 Rifle Only!)", "22 WMR")]
        [InlineData("5mm Rem Mag - 30 Grain SJHP - Aguila - 50 Rounds", "5mm Rem Mag")]
        ...
        [InlineData("Prvi Partizan PPU .357 Magnum FPJ 158grn 50rd Box", "357 Magnum")]
        ...
        [InlineData("Prvi Partizan PPU .44 Magnum 240grn JHP 50rd Box", "44 Magnum")]
        [InlineData("500 Rounds of .44 Mag Ammo by PMC - 180gr JHP", "44 Magnum")]
        [InlineData("Magtech .44 Rem. Magnum 240grn Jacketed Soft Point 50rd Box", "44 Magnum")]
        ...
        [InlineData("50 Rounds of .45 Long-Colt Ammo by Fiocchi - 250gr LRNFP", "45 Long Colt")]
        ...
        [InlineData("PPU 7.62x25 85grn FMJ 50rd Box", "7.62x25 Tokarev")]
        ...
        [InlineData("41 Mag - 210 Grain Semi-Jacketed Soft Point - Remington HTP - 50 Rounds", "41 Magnum")]
        [InlineData("7.62mm Nagant - 98 gr FPJ - Prvi Partizan - 50 Rounds", "7.62mm Nagant")]
        [InlineData("7.62 Nagant - 97 Grain FMJ - Fiocchi - 50 Rounds", "7.62mm Nagant")]
        [InlineData("9x23mm Winchester - 124 gr JSP - Winchester USA - 50 Rounds", "9x23mm Winchester")]
        ...
        [InlineData("32 Gauge - 2-1/2\" 1 / 2oz. #6 Shot - Rio - 250 Rounds", "32 Gauge")]
        ...
        [InlineData("20 Rounds of .243 Win Ammo by Black Hills Gold Ammunition - 85gr TSX", "243")]
        [InlineData("243 - 70 Grain BlitzKing - Sierra Prairie Enemy - 20 Rounds", "243")]
        [InlineData("Prvi Partizan PPU .270 Winchester 150grn SP 20rd Box", "270")]
        [InlineData("270 - 150 Grain PP - Winchester Super-X - 20 Rounds", "270")]
        ...
        [InlineData("375 Win - 200 Grain Sierra Pro-Hunter JFP - HSM - 20 Rounds", "375 Win")]
        [InlineData("Prvi 45-70 SJFP 405grn 20rd Box", "45-70")]
        [InlineData("470 Nitro Express - 500 Grain DGX Bonded - Hornady - 20 Rounds", "470 Nitro")]
        ...
        [InlineData("6mm Creedmoor - 105 Grain BTHP - Hornady BLACK - 20 Rounds", "6mm Creedmoor")]
        [InlineData("Sellier & Bellot 6.5 Creedmoor Ammo 140grn FMJ BT 20rd box", "6.5mm Creedmoor")]
        [InlineData("20 Rounds of 6.5mm Creedmoor Ammo by Sellier & Bellot - 131gr SP", "6.5mm Creedmoor")]
        [InlineData("Prvi Partizan PPU 6.5 Grendel 120grn HP 20rd Box", "6.5mm Grendel")]
        [InlineData("20 Rounds of 6.5mm Grendel  Ammo by Hornady - 123gr SST", "6.5mm Grendel")]
        [InlineData("Norma 6.5 Japanese Arisaka 156grn SP Ammunition 20rd Box", "6.5mm Japanese")]
        [InlineData("Prvi Partizan PPU 6.5x55 Swede 139gr FMJ 20rd Box", "6.5mm Swedish")]
        ...
        [InlineData("Prvi Partizan PPU 7mm Magnum 174gr PSP 20rd Box", "7mm Rem Mag")]
        [InlineData("7mm Rem Mag - 150 Grain GameChanger - Sierra - 20 Rounds", "7mm Rem Mag")]
